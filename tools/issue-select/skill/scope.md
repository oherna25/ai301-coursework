...
tools i have used: git , vscode , github, AI , claude , python , database
things i want to avoid: anything too high tech , anything i dont understand as an intermediate learner 
things i want to get better: use less AI when coding / looking for bugs , understand python and AI better
